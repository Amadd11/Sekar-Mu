                ...
                <div class="p-6 space-y-4 text-xs">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            class="w-full text-xs rounded-lg border-slate-300 p-2.5 bg-white text-slate-800 placeholder-slate-400 focus:border-[#174668] focus:ring-1 focus:ring-[#174668] shadow-2xs resize-y"></textarea>
