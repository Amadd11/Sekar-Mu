    ...
    <div class="bg-white border border-slate-200/90 rounded-xl p-5 shadow-2xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <div class="flex items-center gap-2">
                ...
                <h1 class="text-lg font-bold text-slate-900">
                    Surat Pengajuan & Berkas Akreditasi KEPK (B01-01)
                </h1>
            </div>
            <p class="text-xs text-slate-500 mt-1">
                Daftar seluruh berkas permohonan akreditasi dan evaluasi komite etik yang terdaftar di sistem.
            </p>
        </div>
        ...
        <div>
            <a
                ...
                class="inline-flex items-center gap-1.5 px-4 py-2 bg-teal-700 hover:bg-teal-800 active:bg-teal-900 text-white font-semibold text-xs rounded-lg shadow-2xs transition"
                wire:navigate
            >
                <span>➕</span>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-5 py-12 text-center text-slate-400">
                                Belum ada berkas surat pengajuan yang dibuat.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
