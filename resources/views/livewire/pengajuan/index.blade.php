<div class="space-y-6 max-w-7xl mx-auto pb-12">
                ...
                <tbody class="divide-y divide-slate-100 bg-white">
                    ...
                    <tr class="hover:bg-slate-50/60 transition group">
                        ...
                        <td class="px-6 py-3.5 text-right whitespace-nowrap">
                            <div class="inline-flex items-center justify-end gap-1.5 bg-slate-100/70 p-1 rounded-2xl border border-slate-200/80 shadow-2xs">
                                @if (auth()->user()->isAdmin())
                                <a
                                    href="{{ route('penilaian.tugaskan', $item) }}"
                                    title="Tugaskan Tim Asesor"
                                    class="w-8 h-8 rounded-xl flex items-center justify-center text-teal-700 bg-white hover:bg-teal-50 hover:border-teal-200 border border-slate-200 transition-all shadow-2xs hover:scale-105 cursor-pointer"
                                    wire:navigate>
                                ...
                                <a
                                    ...
                                    title="Edit Nomor & Identitas Berkas"
                                    class="w-8 h-8 rounded-xl flex items-center justify-center text-slate-700 bg-white hover:bg-slate-50 border border-slate-200 transition-all shadow-2xs hover:scale-105 cursor-pointer"
                                    wire:navigate>
                                ...
                                <button
                                    ...
                                    class="w-8 h-8 rounded-xl flex items-center justify-center text-rose-600 bg-white hover:bg-rose-50 hover:text-rose-700 hover:border-rose-200 border border-slate-200 transition-all shadow-2xs hover:scale-105 cursor-pointer">
                                    <span class="material-symbols-outlined text-[16px]">delete</span>
                                </button>
                                @endcan

                                <div class="w-px h-4 bg-slate-300/80 mx-0.5"></div>

                                <a
                                    href="{{ route('pengajuan.show', $item) }}"
                                    title="Buka Lembar Kerja Berkas"
                                    class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold text-white bg-primary-700 hover:bg-primary-600 active:bg-primary-800 transition shadow-2xs hover:scale-[1.02]"
                                    wire:navigate>
                                    <span>Buka</span>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea
                                        ...
                                        class="w-full text-xs rounded-xl border border-slate-300 py-2 px-3 focus:border-primary-600 focus:ring-2 focus:ring-primary-500/20 shadow-2xs placeholder:text-slate-400"></textarea>
                                </div>
    ...
    <!-- Reusable Modal Konfirmasi Hapus Berkas -->
    <x-confirm-modal
        ...
        <p>
            Apakah Anda yakin ingin menghapus berkas pengajuan ini? Seluruh data isian borang, instrumen evaluasi diri, dan dokumen lampiran akan <strong class="text-slate-700 font-semibold">dihapus secara permanen</strong> dari sistem.
        </p>
