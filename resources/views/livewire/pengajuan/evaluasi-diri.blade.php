        ...
        <div class="p-5 sm:p-6 border-t border-slate-100 grid grid-cols-1 md:grid-cols-3 gap-4 bg-slate-50/40">
            ...
            <div class="space-y-1.5">
                ...
                <textarea
                    ...
                    class="w-full bg-white border border-slate-200 rounded-xl focus:ring-1 focus:ring-primary-500 focus:border-primary-500 text-xs p-3 resize-y transition placeholder:text-slate-400"></textarea>
            </div>
                        ...
                        <tr class="hover:bg-slate-50/60 transition-colors align-top {{ $rowBg }}">
                            ...
                            <td class="py-4 px-4 align-top">
                                <textarea
                                    ...
                                    class="w-full bg-white border border-slate-200 rounded-xl focus:ring-1 focus:ring-primary-500 focus:border-primary-500 text-xs p-2.5 min-h-[70px] resize-y transition placeholder:text-slate-400"></textarea>
                            </td>
