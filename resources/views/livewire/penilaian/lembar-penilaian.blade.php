                                            ...
                                            <td class="py-4 px-4 align-top space-y-2">
                                                ...
                                                <div>
                                                    <textarea
                                                        ...
                                                        class="w-full text-xs rounded-xl border-slate-300 p-2.5 bg-white text-slate-800 placeholder-slate-400 focus:border-[#174668] focus:ring-2 focus:ring-[#174668]/15 shadow-2xs resize-y"
                                                    ></textarea>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <form wire:submit="simpanPenilaian" class="space-y-5 text-xs">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                class="w-full text-xs rounded-xl border border-slate-300 p-3.5 focus:border-primary-600 focus:ring-2 focus:ring-primary-500/20 shadow-2xs leading-relaxed"
                            ></textarea>
                            @error('catatan')
            ...
            <div class="bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-7 shadow-xs space-y-6">
                ...
                <div class="pt-4 border-t border-slate-100 space-y-3">
                    ...
                    <textarea
                        ...
                        class="w-full text-xs rounded-xl border border-slate-300 p-3.5 focus:border-primary-600 focus:ring-2 focus:ring-primary-500/20 shadow-2xs"
                    ></textarea>
                    @error('catatanBaru')
